...
Pod::Spec.new do |s|
  ...
  s.dependency 'ReactCommon/jscallinvoker', react_native_version
  s.dependency 'ReactCommon/turbomodule/core', react_native_version
  s.dependency 'React-ART',  react_native_version
  # s.dependency 'React-RCTFabric',  react_native_version
  # s.dependency 'React-Fabric', react_native_version

  s.dependency 'react-native-geolocation', "2.0.2"

  #third party pods
  s.dependency 'Yoga', '1.14.0' #use from official repo
  react_podspecs = [
